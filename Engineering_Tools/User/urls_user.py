...
from .views import Home_View_User,My_Account_View, Update_Account_Info_View, All_Company_View, All_Product_By_Company, Product_Details_View, Add_Product_Review_View, User_Wishlist_View
