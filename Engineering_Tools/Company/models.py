...
def upload_image_path(instance, filename):
    ...
    return "Company/Company_logo/{final_filename}".format(final_filename=final_filename)
...
class Company_Profile(models.Model):
    ...
    c_logo = models.ImageField(upload_to = upload_image_path ,blank=True, null = True)
