...
from .views import  Add_To_Wish_List_View, Remove_From_Wish_List_View, Add_To_Wish_List_From_All_product_View,  Remove_From_Wish_List_From_All_Product_View, Remove_From_WishList_View, Add_To_Cart_From_Details_View, Remove_From_Cart_From_Details_View
app_name = "Cart"
